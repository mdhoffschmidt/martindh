...
export const Article = () => {
    return (
        <div>
            ...
            <p>
                We won't try to predict the exact number of NFT users we will rather consider a lower bound on that amount of users.
                To do so, we consider three ratios :
            </p>
                
            <ul>
                <li> Wallets per user ratio : the number of wallets used on average by a single user. </li>
                <li> NFT traders ratio : the number of addresses that have traded at least one NFT over the total number of wallets. </li>
                <li> NFT active wallet ratio : the number of addresses that are currently holding at least one NFT </li>
            </ul>

            <p>
                We compute the ratios in the table below given the number we have. 
            </p>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr> 
                        <td className="text-left"> Wallets per user ratio </td>
                        <td> 5.2% </td> 
                        <td> 5.2% </td>
                        <td className="italic"> 5.2% (estimated) </td>
                    </tr>

                    <tr> 
                        <td className="text-left"> NFT traders ratio </td> 
                        <td> 2.2% </td> 
                        <td> 3.9% </td>
                        <td className="italic"> 3.9% (estimated) </td>
                    </tr>

                    <tr> 
                        <td className="text-left"> NFT holders vs. active users ratio </td> 
                        <td> 1.4% </td> 
                        <td className="italic"> 1.4% (estimated) </td>
                        <td className="italic"> 1.4% (estimated) </td>
                    </tr>
            ...
            <p>
                We consider the last up to date ratio will remain identical by 2031.
                Of course, that is not true.
                In fact, we expect it to be higher.
                But here we want to consider the minimum range or lower bound on the NFT users.
                Given this ratios we can compute the number of NFT traders by 
            </p>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr> 
                        <td className="text-left"> Estimated number of users </td> 
                        <td> 25 million <a href="https://a16zcrypto.com/state-of-crypto-report-a16z-2022/"> (a16z) </a> </td>
                        <td className="italic"> 29 million (estimated) </td>
                    ...
                    <tr> 
                        ...
                        <td> 129 million <a href="https://dune.com/queries/1103912/1884830"> (Dune) </a> </td>
                        <td> 145 million <a href="https://dune.com/queries/1103912/1884830"> (Dune) </a> </td> 
                        <td className="italic"> 5.2 billion (estimated) </td>
                    </tr>
                    ...
                    <tr> 
                        ...
                        <td> 2.8 million </td> 
                        <td> 5.6 million </td>
                        <td className="italic"> 203 million (estimated) </td>
                    </tr>

                    <tr> 
                        <td className="text-left"> Number of addresses holding at least one NFT </td>
                        <td> 360,000 (chainanalysis) </td> 
                        <td className="italic"> 415,000 (estimated) </td>
                        <td className="italic"> 14,300,000 (estimated) </td>
                    </tr>
